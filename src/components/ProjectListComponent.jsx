...
let projectTitles=['INT Magazine','Meditative Musical Drum','Resume','title 4','title 5'];
...
'Minimum viable product for phone app to create self-designed meditative music','description 3','description 4','description 5'];
...
let projectURL=['http://www.intmagazine.com/',
'https://meditativemusicaldrum.netlify.app/',Resume,'URL 4','URL 5'];
let projectURLList=[];
